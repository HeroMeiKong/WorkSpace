...
/*统计*/
const BaseCount = loadable(() => import('./Count/BaseCount'));
const GiftCount = loadable(() => import('./Count/GiftCount'));
const ShopCount = loadable(() => import('./Count/ShopCount'));
/*
* @name 菜单名
* @path 路径
* @component 组件
...
const menus = [
  ...
  {name: '统计',
    ...
    template: [...all],
    children: [
      {name: '基础统计', path: 'basecount', component: BaseCount, template: [...all],},
      {name: '打赏统计', path: 'giftcount', component: GiftCount, template: [...all],},
      {name: '购物统计', path: 'shopcount', component: ShopCount, template: [...all],},
    ]
  },
];
