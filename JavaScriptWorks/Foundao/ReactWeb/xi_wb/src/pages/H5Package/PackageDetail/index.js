...
class PackageDetail extends Component {
  ...
  addEcharts = () => {
    if (!document.querySelector('#echartsJS')) {
      window.$('head').append(`<script id="echartsJS" src="/echarts/echarts.min.js"></script>`)
    }
    if (!document.querySelector('#echartsChina')) {
      window.$('head').append(`<script id="echartsChina" src="/echarts/china.js"></script>`)
    }
  };
  // 获取包装详情
  getPackageDetail = () => {
