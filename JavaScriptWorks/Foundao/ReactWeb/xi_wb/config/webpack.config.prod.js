...
const htmlBaseConfig = require('./htmlConfig');
const getClientEnvironment = require('./env');
/*预渲染插件*/
const PrerenderSPAPlugin = require('prerender-spa-plugin');

let htmlConfig = htmlBaseConfig.zh;
if (process.env.ENGLISH !== 'false') {
  htmlConfig = htmlBaseConfig.en;
}
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      // filename: 'index_react.html',//线上
      keywords: htmlConfig.keywords,
