...
Page({
  ...
  data: {
    ...
    duration: 0,
    movableviewNum: [], 
    previewpic: '../../assets/images/2null2@2x.png',
    ...
    musiclists: [[{id: '0',pic: '../../assets/images/2attention3@2x.png',music_type_id: '3',name: '秘语'},
                 ...
                 {id: '1',pic: '../../assets/images/2attention3@2x.png',music_type_id: '3',name: '秘语'}]],
    showmusiclists: [],
    showoption: 'flex', //值为flex或者none
    showfilter: 'none',
    showpaster: 'none',
    //chosethispaster: {text: 'chosethispaster',interest: 'none',doodle: 'none'}, //值为chosethispaster或者none
    showmusic: 'none',
    musicimgs: {playimg: '../../assets/images/1huati@2x.png',addimg: '../../assets/images/1huati@2x.png'},
    showmusiclist: 'none',
  },
  ...
  paster (e) {
    ...
    wx.request({
      ...
      success: (resp) => {
          ...
          console.log(that.data.pasterId)
          that.setData({
