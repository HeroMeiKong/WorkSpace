...
export default {
    ...
    upload_cover: hostTest + 'upload_cover.php',
    ...
    upload_test: hostTest + 'video/get_video_cover.php',
    upload_submit: hostTest + 'video/user_upload_submit.php',
    get_submit: hostTest + 'video/get_submit_job.php',
